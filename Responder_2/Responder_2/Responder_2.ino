...
const char BROADCAST_ID_1 = 0xFF;
const char BROADCAST_ID_2 = 0x00;
char myBroadcastID;  // Will be set to either BROADCAST_ID_1 or BROADCAST_ID_2
  ...
  switch(current_state) {
    ...
    case STATE_RECEIVE:
    {
      if (received == true)
      {
        ...
        if (rx_packet[DST_IDX] == myBroadcastID && rx_packet[0] == POLL_MSG_TYPE) {
